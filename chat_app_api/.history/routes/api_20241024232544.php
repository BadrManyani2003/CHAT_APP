...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/users', [UserController::class, 'show']); // Affiche un utilisateur spécifique
    Route::post('/users', [UserController::class, 'store']); // Crée un nouvel utilisateur
    Route::put('/users', [UserController::class, 'update']); // Met à jour un utilisateur
    Route::delete('/users', [UserController::class, 'destroy']); // Supprime un utilisateur
    ...
    Route::post('/publications/comments', [CommentController::class, 'store']); // Crée un commentaire pour une publication
    Route::put('/comments', [CommentController::class, 'update']); // Met à jour un commentaire
    Route::delete('/comments', [CommentController::class, 'destroy']); // Supprime un commentaire
