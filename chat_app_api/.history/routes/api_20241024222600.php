...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/publications/{publicationId}/comments', [CommentController::class, 'index']); // Liste les commentaires d'une publication
    Route::post('/publications/{publicationId}/comments', [CommentController::class, 'store']); // Crée un commentaire pour une publication
