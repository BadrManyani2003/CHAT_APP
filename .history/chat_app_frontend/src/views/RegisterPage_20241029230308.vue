...
export default {
  ...
  methods: {
    onFileChange(event) {
      ...
      if (file) {
        console.log('Fichier sélectionné:', file); // Vérification
    ...
    async register() {
      ...
      // Vérification que imgprofile n'est pas nul
      if (this.imgprofile) {
        console.log('Ajout de l\'image de profil:', this.imgprofile); // Vérification
