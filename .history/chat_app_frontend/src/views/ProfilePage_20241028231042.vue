...
const handleImageUpload = (event) => {
  ...
  if (file && file.type.startsWith("image/")) {
    formData.value.imgprofile = file;
  } else {
    formData.value.imgprofile = null; // Réinitialisez si le fichier n'est pas une image
    console.error("Veuillez sélectionner un fichier d'image valide.");
  }
};
...
const updateProfile = async () => {
  try {
    ...
    // Ajoutez l'image seulement si elle est sélectionnée et valide
