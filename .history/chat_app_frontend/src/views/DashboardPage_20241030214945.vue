...
import { useUserStore } from '@/store/userStore'; // Ensure the path is correct
...
export default {
  setup() {
    ...
    return { user, profileImage, dropdownOpen, toggleDropdown, logout };
  },
};
</script>
...
<style scoped>
.dropdown {
  margin-top: 15rem; /* Adjust margin if necessary */
  margin-right: 10rem; /* Adjust margin if necessary */
  background: #f1f1f1;
}
</style>
