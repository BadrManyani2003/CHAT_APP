...
export default {
  data() {
    return {
      ...
      imgprofile: null, // Ajouter imgprofile
      errorMessage: ''
    };
  },
  methods: {
  ...
  try {
    ...
    if (this.imgprofile) {
      // Assurez-vous que l'image est bien au format File
      if (this.imgprofile instanceof File) {
        data.append("imgprofile", this.imgprofile);
      } else {
        this.errorMessage = "Le fichier d'image est invalide.";
        return;
      }
    }
