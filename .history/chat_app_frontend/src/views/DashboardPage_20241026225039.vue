        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          >
            ...
            <img
              ...
              :src="user && user.imgprofile ? user.imgprofile : 'http://127.0.0.1:8000/storage/default/default.jfif'" 
              alt="user photo"
            />
          </button>
          <!-- Dropdown menu -->
          ...
          >
            <div class="px-4 py-3">
              <span class="block text-sm text-gray-900 dark:text-white">{{ user ? user.name : 'Utilisateur' }}</span>
              <span class="block text-sm text-gray-500 truncate dark:text-gray-400">{{ user ? user.email : 'email@example.com' }}</span>
            </div>
