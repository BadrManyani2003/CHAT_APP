...
export const useUserStore = defineStore('userStore', {
  state: () => ({
    ...
    isAuthenticated: !!localStorage.getItem('accessToken'), // État d'authentification
  }),
  ...
  actions: {
    ...
    loadUser() {
      ...
      if (user && token) {
        ...
        this.clearUserData(); // Nettoie si les données sont absentes ou incorrectes
      }
    },
    ...
    clearUserData() {
      ...
      api.setAuthToken(null); // Retire le token des requêtes futures
    },
